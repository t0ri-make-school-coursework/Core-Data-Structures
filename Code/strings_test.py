...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('acc', 'cc') is True
        assert contains('acb', 'cb') is True
        assert contains('bac', 'bac') is True
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('abc', 'cd') is False
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('aaaaaa', 'aaaaaa') is True
        assert contains('nanana', 'ana') is True
        assert contains('sananab', 'bananas') is False
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        assert find_index('aba', 'abc') is None
        assert find_index('xyz', 'abc') is None
        assert find_index('cba', 'abc') is None
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        assert find_index('etcetera', 'etc') == 0
        assert find_index('etcetera', 'et') == 0
        assert find_index('aretecet', 'ete') == 2
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        assert find_all_indexes('pepperoni', 'pero') == [3]
        assert find_all_indexes('pepperoni', 'pe') == [0, 3]
        assert find_all_indexes('etcetera', 'et') == [0, 3]
